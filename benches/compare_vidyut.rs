...
use vidyut_lipi::{Scheme, Mapping, transliterate};
...
fn get_test_corpus() -> Vec<(&'static str, usize)> {
    vec![
        ...
        (Box::leak("तत्र शूरा महेष्वासा भीमार्जुनसमा युधि । युयुधानो विराटश्च द्रुपदश्च महारथः ॥ ".repeat(50).into_boxed_str()) as &'static str, 500),
    ]
}
