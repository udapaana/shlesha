...
const MEDIUM_ITRANS: &str = "dharma yoga bhArata sa~nskR^ita veda upaniShad gItA rAmAyaNa mahAbhArata";
...
fn bench_roman_to_indic(c: &mut Criterion) {
    ...
    // IAST to Devanagari
    for (size, text) in [("small", SMALL_IAST), ("medium", MEDIUM_IAST), ("large", LARGE_IAST)] {
        group.bench_with_input(
            BenchmarkId::new("iast_to_devanagari", size),
            &text,
            |b, &text| {
                b.iter(|| {
                    transliterator.transliterate(text, "iast", "devanagari").unwrap()
                })
            }
        );
    }
    ...
    for (size, text) in [("small", SMALL_ITRANS), ("medium", MEDIUM_ITRANS), ("large", LARGE_ITRANS)] {
        group.bench_with_input(
            BenchmarkId::new("itrans_to_devanagari", size),
            &text,
            |b, &text| {
                b.iter(|| {
                    transliterator.transliterate(text, "itrans", "devanagari").unwrap()
                })
            }
        );
    }
    ...
    // SLP1 to Devanagari
    for (size, text) in [("small", SMALL_SLP1), ("medium", MEDIUM_SLP1), ("large", LARGE_SLP1)] {
        group.bench_with_input(
            BenchmarkId::new("slp1_to_devanagari", size),
            &text,
            |b, &text| {
                b.iter(|| {
                    transliterator.transliterate(text, "slp1", "devanagari").unwrap()
                })
            }
        );
    }
...
fn bench_roman_to_roman(c: &mut Criterion) {
    ...
    for (size, text) in [("small", SMALL_IAST), ("medium", MEDIUM_IAST), ("large", LARGE_IAST)] {
        group.bench_with_input(
            ...
            |b, &text| {
                b.iter(|| {
                    transliterator.transliterate(text, "iast", "itrans").unwrap()
                })
            }
        );
    }
    ...
    for (size, text) in [("small", SMALL_IAST), ("medium", MEDIUM_IAST), ("large", LARGE_IAST)] {
        group.bench_with_input(
            BenchmarkId::new("iast_to_slp1", size),
            &text,
            |b, &text| {
                b.iter(|| {
                    transliterator.transliterate(text, "iast", "slp1").unwrap()
                })
            }
        );
    }
    ...
    for (size, text) in [("small", SMALL_ITRANS), ("medium", MEDIUM_ITRANS), ("large", LARGE_ITRANS)] {
        group.bench_with_input(
            ...
            |b, &text| {
                b.iter(|| {
                    transliterator.transliterate(text, "itrans", "slp1").unwrap()
                })
            }
        );
    }
...
fn bench_devanagari_to_roman(c: &mut Criterion) {
    ...
    // Devanagari to IAST
    for (size, text) in [("small", SMALL_DEVA), ("medium", MEDIUM_DEVA), ("large", LARGE_DEVA)] {
        group.bench_with_input(
            BenchmarkId::new("devanagari_to_iast", size),
            &text,
            |b, &text| {
                b.iter(|| {
                    transliterator.transliterate(text, "devanagari", "iast").unwrap()
                })
            }
        );
    }
    ...
    for (size, text) in [("small", SMALL_DEVA), ("medium", MEDIUM_DEVA), ("large", LARGE_DEVA)] {
        group.bench_with_input(
            ...
            |b, &text| {
                b.iter(|| {
                    transliterator.transliterate(text, "devanagari", "itrans").unwrap()
                })
            }
        );
    }
    ...
    for (size, text) in [("small", SMALL_DEVA), ("medium", MEDIUM_DEVA), ("large", LARGE_DEVA)] {
        group.bench_with_input(
            ...
            |b, &text| {
                b.iter(|| {
                    transliterator.transliterate(text, "devanagari", "slp1").unwrap()
                })
            }
        );
    }
