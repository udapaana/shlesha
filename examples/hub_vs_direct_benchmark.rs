...
fn main() {
    ...
    let test_cases = vec![
        ...
        ("Telugu → SLP1", "telugu", "slp1", Scheme::Telugu, Scheme::Slp1, "ధర్మక్షేత్ర"),
        ("Telugu → IAST", "telugu", "iast", Scheme::Telugu, Scheme::Iast, "ధర్మక్షేత్ర"),
        ("Bengali → SLP1", "bengali", "slp1", Scheme::Bengali, Scheme::Slp1, "ধর্মক্ষেত্র"),
        ("Bengali → IAST", "bengali", "iast", Scheme::Bengali, Scheme::Iast, "ধর্মক্ষেত্র"),
        ("Tamil → SLP1", "tamil", "slp1", Scheme::Tamil, Scheme::Slp1, "தர்மக்ஷேத்ர"),
        
        // Roman → Indic conversions  
        ("SLP1 → Telugu", "slp1", "telugu", Scheme::Slp1, Scheme::Telugu, "dharmakSetra"),
        ("IAST → Telugu", "iast", "telugu", Scheme::Iast, Scheme::Telugu, "dharmakṣetra"),
        ("SLP1 → Bengali", "slp1", "bengali", Scheme::Slp1, Scheme::Bengali, "dharmakSetra"),
        ("IAST → Bengali", "iast", "bengali", Scheme::Iast, Scheme::Bengali, "dharmakṣetra"),
        ("SLP1 → Tamil", "slp1", "tamil", Scheme::Slp1, Scheme::Tamil, "dharmakSetra"),
        
        // Cross-Indic conversions (3-hop for Shlesha vs direct for Vidyut)
        ("Telugu → Bengali", "telugu", "bengali", Scheme::Telugu, Scheme::Bengali, "ధర్మక్షేత్ర"),
        ("Bengali → Telugu", "bengali", "telugu", Scheme::Bengali, Scheme::Telugu, "ধর্মক্ষেত্র"),
        ("Tamil → Malayalam", "tamil", "malayalam", Scheme::Tamil, Scheme::Malayalam, "தர்மக்ஷேத்ர"),
        ("Telugu → Tamil", "telugu", "tamil", Scheme::Telugu, Scheme::Tamil, "ధర్మక్షేత్ర"),
    ];
    ...
    for (scale_name, repeat_count, iterations) in text_scales {
        ...
        for (conversion_name, shlesha_from, shlesha_to, vidyut_from, vidyut_to, base_text) in &test_cases {
            ...
            if shlesha_success {
                ...
                println!("  📚 Shlesha (Hub):  {:.2} MB/s ({:?} avg)", shlesha_throughput, shlesha_avg);
                println!("  🚀 Vidyut (Direct): {:.2} MB/s ({:?} avg)", vidyut_throughput, vidyut_avg);
                ...
                if text_len < 20 {
                    ...
                    if shlesha_norm == vidyut_norm {
                        ...
                        println!("      Shlesha: {}", shlesha_result.chars().take(30).collect::<String>());
                        println!("      Vidyut:  {}", vidyut_result.chars().take(30).collect::<String>());
                    }
                }
            }
            println!("");
