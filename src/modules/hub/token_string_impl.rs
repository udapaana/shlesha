...
impl_token_string!(AbugidaToken,
    ...
    ConsonantC, ConsonantCh, ConsonantJ, ConsonantJh, ConsonantNy,
    ConsonantT, ConsonantTh, ConsonantD, ConsonantDh, ConsonantN,
    ConsonantTt, ConsonantTth, ConsonantDd, ConsonantDdh, ConsonantNn,
    ConsonantP, ConsonantPh, ConsonantB, ConsonantBh, ConsonantM,
    ConsonantY, ConsonantR, ConsonantL, ConsonantV, ConsonantLl,
    ConsonantSh, ConsonantSs, ConsonantS, ConsonantH,
    MarkAnusvara, MarkVisarga, MarkCandrabindu, MarkNukta, MarkVirama, MarkAvagraha,
    MarkUdatta, MarkAnudatta, MarkDoubleSvarita, MarkTripleSvarita,
    ConsonantQa, ConsonantZa, ConsonantFa, ConsonantGha, ConsonantKha,
    ConsonantRra, ConsonantRrha, ConsonantYa,
    Digit0, Digit1, Digit2, Digit3, Digit4, Digit5, Digit6, Digit7, Digit8, Digit9
);

// Implement for AlphabetToken
impl_token_string!(AlphabetToken,
    VowelA, VowelAa, VowelI, VowelIi, VowelU, VowelUu,
    VowelVocalicR, VowelVocalicRr, VowelVocalicL, VowelVocalicLl,
    VowelE, VowelAi, VowelO, VowelAu,
    ConsonantK, ConsonantKh, ConsonantG, ConsonantGh, ConsonantNg,
