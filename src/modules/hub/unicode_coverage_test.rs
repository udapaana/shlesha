...
mod unicode_coverage_test {
    ...
    fn verify_devanagari_unicode_coverage() {
        ...
        for chars in [&various_signs, &independent_vowels, &consonants, &various_signs_2,
                      &dependent_vowel_signs, &additional_signs, &additional_consonants, &additional_vowels] {
            for (ch, _) in chars {
                total_chars += 1;
        ...
        println!("Coverage: {:.1}%", (mapped_chars as f64 / total_chars as f64) * 100.0);
