...
mod validation_tests {
    ...
    fn test_schema_validation_empty_mappings() {
        ...
        assert!(result.is_ok(), "Empty mappings should be allowed by current validation");
    }
...
"#;
    ...
    fn test_schema_overwrite_behavior() {
        ...
        original_schema.mappings.insert("a".to_string(), "original".to_string());
        registry.register_schema("overwrite_test".to_string(), original_schema).unwrap();
        ...
        new_schema.mappings.insert("a".to_string(), "new".to_string());
        registry.register_schema("overwrite_test".to_string(), new_schema).unwrap();
...
"#;
        ...
        let first_script_type = registry.get_schema("cache_test").unwrap().script_type.clone();
    ...
    fn test_clear_registry_functionality() {
        ...
        registry.register_schema("clear_test1".to_string(), schema1).unwrap();
        registry.register_schema("clear_test2".to_string(), schema2).unwrap();
...
"#;
        ...
        assert_eq!(schema.metadata.description, Some("Test schema with full metadata".to_string()));
